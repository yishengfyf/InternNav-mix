    ...
    agent=AgentCfg(
        ...
        model_settings={
            ...
            "vlmap_safety": {
                ...
                # After repeated local blocks, stop overriding actions and let S2/Habitat continue.
                # This prevents VLMap from hijacking long episodes with hundreds of forced turns.
                "max_safety_changes_per_cluster": 8,
                "max_safety_changes_per_episode": 35,
                "replan_on_budget_exhaustion": True,
                "max_budget_replans_per_episode": 3,
                "shadow_only": False,
                "debug": True,
                ...
                "debug_force_cluster_block_count": 8,
                "debug_force_cluster_block_interval": 5,
                "debug_force_max_snapshots": 15,
