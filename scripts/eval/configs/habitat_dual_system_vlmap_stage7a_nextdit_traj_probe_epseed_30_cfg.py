...
# V7a is a shadow-only feasibility probe for NextDiT trajectory reranking.
# NextDiT already returns multiple trajectory samples; the current baseline
# averages them before converting to actions. This probe scores individual
# samples with the existing VLMap trajectory rollout, logs whether there is a
# safer/diverse alternative, and still executes the original averaged actions.
...
vlmap_cfg["debug_dir"] = (
    "./logs/habitat/compare_vlmap_stage7a_30_nextdit_traj_probe_epseed/"
    "vlmap_safety_debug"
)
...
eval_cfg.eval_settings["port"] = "2366"
