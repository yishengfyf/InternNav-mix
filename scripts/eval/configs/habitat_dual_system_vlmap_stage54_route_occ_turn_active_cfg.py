"""Stage54 exploratory active: route-OCC candidates may guide one turn only."""
...
vlmap_cfg["s2_loop_path_reobserve_m3_candidate_stage"] = "route_occ"
vlmap_cfg["s2_loop_path_reobserve_m3_safety_mode"] = "route_occ_turn_only"
...
eval_cfg.eval_settings["port"] = os.environ.get("STAGE54_EVAL_PORT", "3542")
